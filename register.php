            ...
            $error_message = "Email already exists, please choose another one.";
                   ...
                   // Check mobile number
                    ...
                    if (!preg_match($r, $phone)) {
                        $error_message = 'Sorry, Phone number must start with 07';
                    } else {
                    ...
                    if ($uploadOk == 0) {
                        ...
                        if (move_uploaded_file($_FILES["profile_pic"]["tmp_name"], $target_file)) {
                            ...
                            // write to database
                            $role = "user";
                            $sql = "INSERT INTO user (fname, lname, email, phone, password,city,role,profile_pic)
            VALUES ('$firstname', '$lastname', '$email', '$phone', '$password','$city','$role', '$target_file')";
...
<head>
    <meta charset="utf-8">
    <title>Uncle Musl7 - Register</title>
        ...
        <div class="container " >
            ...
            <div class="col-lg-12 col-md-6 wow fadeInUp " data-wow-delay="0.3s">
                ...
                <div class="mx-auto m-3" style="width: 400px;">
                    ...
                    <h6 class="text-dark mb-10" style="margin-top: 20px;">  <a href="Wregister.php">Signup as a Worker</a>.</h6>
                    </div>
                </form>
                </div>
            </div>
