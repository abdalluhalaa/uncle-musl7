...
$p = '<div class="nav-item dropdown">
        ...
        <a href="oadmin.php" class="dropdown-item active">Orderes</a>';
}
//  admin panel end    
...
<head>
    <meta charset="utf-8">
    <title>Uncle Musl7 - Orders</title>
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">The Orders</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Admin panel</a></li>
                    <li class="breadcrumb-item active" aria-current="page">The Orders</li>
                </ol>
            </nav>
        </div>
    </div>
  ...
  <tbody>
    <tr>
      ...
      <td>' . $row['des'] . '</td>
      <td>' . $row['status'] . '</td>
      <td><a class="btn btn-primary px-3 d-none d-lg-block" href="edit_order.php?id=' . $row['id'] . '">Edit</a></td>
      <td> <a class="btn btn-primary px-3 d-none d-lg-block" href="delete_order.php?id=' . $row['id'] . '">Delete</a></td>
    </tr>
  </tbody>
              ...
              /*  
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="bg-light text-center h-100 p-5">
                                ...
                                <h6 class="mb-4">Worker Email: ' . $row['worker_email'] . '</h6>
                                <hr class="w-200">
                                <h6 class="mb-4">User Email: ' . $row['user_email'] . '</h6>
                                <hr class="w-200">
                                ...
                                <a class="btn btn-primary px-3 d-none d-lg-block" href="edit_order.php?id=' . $row['id'] . '">Edit</a><br>
                                <a class="btn btn-primary px-3 d-none d-lg-block" href="delete_order.php?id=' . $row['id'] . '">Delete</a>
                                <hr class="w-200">
