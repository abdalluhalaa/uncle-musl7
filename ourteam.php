...
<head>
    <meta charset="utf-8">
    <title>Uncle Musl7 - Our Team</title>
...
<body>
                    ...
                    <?php if(!isset($_SESSION["logged_in"]) || $_SESSION["logged_in"] !== true){
                        ...
                        <?php if(!isset($_SESSION["logged_in"]) || $_SESSION["logged_in"] !== true){
                            ...
                            echo '<a href="my_appointments.php" class="dropdown-item">My Orders</a>';
                                    ...
                                    ?>
                        <a href="ourteam.php" class="dropdown-item active">Our Team</a>
 ...
 <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <div class="text-center mx-auto pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h2 class=" mt-5 mb-4">The perfect repair service team</h2>
            </div>
    <div class="row g-4">
    ...
    $conn = mysqli_connect('sql306.epizy.com', 'epiz_33450722', 'A96HNCY1Dsv', 'epiz_33450722_users');
        ...
        $sql = "SELECT fname, lname, email, category, city,role,profile_pic FROM user WHERE  (role = 'worker')";
                    ...
                    <div class="team-item">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="position-relative overflow-hidden bg-light d-flex flex-column justify-content-center w-100 ps-4"
                                ...
                                <h6 class="text-dark"> Rate: '. $roww['avgrate'] .'</h6>
