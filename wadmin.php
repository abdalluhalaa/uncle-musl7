...
$p = '<div class="nav-item dropdown">
            ...
            <a href="wadmin.php" class="dropdown-item active">workers</a>
...
if(isset($_POST['edit'])){
    ...
    $sql = "UPDATE user SET fname = '$fname', lname = '$lname', email = '$email', phone = '$phone', city = '$city', category = '$category' WHERE id = $id";
...
$sql = "SELECT id, fname, lname, email,phone ,category, city FROM user WHERE  (role = 'worker')";
...
<head>
    <meta charset="utf-8">
    <title>Uncle Musl7 - Workers</title>
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">The workers</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Admin panel</a></li>
                    <li class="breadcrumb-item active" aria-current="page">The workers</li>
                </ol>
            </nav>
        </div>
    </div>
...
<body>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                    <input type="text" name="role" value="<?php echo $row['category']; ?>">
            </td>
            <td>
                    <input class="btn btn-primary " type="submit" name="edit" value="Edit">
                    <a class="btn btn-primary " href="wadmin.php?delete=<?php echo $row['id']; ?>">Delete</a>
                </form>
            </td>
        </tr>
        <?php } ?>
