...
<head>
    <meta charset="utf-8">
    <title>Uncle Musl7 - Change Password</title>
...
<body>
 ...
 <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight"> Change Password</h1>
...
<h2     class="m-5" >Change Password</h2>
...
<div class="mx-auto m-3" style="width: 400px;">
    ...
    <input class='btn mt-5 btn-primary py-3 px-5' type="submit"  value="Change Password">
</form>
</div></div></div></div>
