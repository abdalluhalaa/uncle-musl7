...
<head>
    <meta charset="utf-8">
    <title>Uncle Musl7 - Ratings and Reviews</title>
...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">Ratings and Reviews</h1>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-6 mt-5 mb-4">The highest standard. </h1>
                    <h1 class="display-6 mt-5 mb-4">The happiest customer. </h1>
                    ...
                    <div class="row g-4">
                        ...
                        <form method="post" action="rate_worker_submit.php">
                        <div class="row g-3">
                        ...
                        <div class="col-12">
                                <div class="form-floating">
                                    <input style="height: 150px" type="text" class="form-control" name="review" id="review" placeholder="Review">
                                    <label for="review">Review</label>
                                </div>
                            </div>
                            </div>
                            <input class='btn mt-5 btn-primary py-3 px-5' type="submit" value="Rate">
