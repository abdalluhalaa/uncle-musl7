...
<head>
    <meta charset="utf-8">
    <title>Uncle Musl7 - Client Profile</title>
...
<body>
 ...
 <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">Client Profile</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="index.php">MY Appointments</a></li>
...
<?php
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $sql = "SELECT user.fname, user.lname, user.email,user.city, user.phone,user.profile_pic FROM appointments JOIN user ON appointments.user_email = email WHERE appointments.id = $appointment_id";
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="testimonial-img position-relative">
                        <img class="img-fluid rounded-circle mx-auto mb-5" src="'.$profile_pic.'">
                        
                    </div>
                
                <h6 class="mb-4">Name: '.  $fname . " " . $lname .  '</h6>
                <hr class="w-200">
                <h6 class="mb-2">Email: '. $email . '</p>
                <hr class="w-200">
                <h6 class="mb-4">Phone Number: ' . $phone . '</p>
                <hr class="w-200">
                <h6 class="mb-4">City: ' . $city . '</p>
                <hr class="w-200">
                <a class="btn btn-primary px-4" href="index.php">Back to Home</a>
                <br><br>
                <a class="btn btn-primary px-4" href="wo.php">My Appointments</a>
