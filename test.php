    ...
    $conn = mysqli_connect('sql306.epizy.com', 'epiz_33450722', 'A96HNCY1Dsv', 'epiz_33450722_users');
       ...
       $worker_email = $_POST['email'];
        ?> 
                        ...
                        <form action="order_worker_submit.php" method="post">
                        <div class="row g-3">

                        <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="date" class="form-control" name="date" id="date" placeholder="Select the date:">
                                    <label for="date">Select the date:</label>
                                </div>
                        </div>
                        <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="time" class="form-control" name="time" id="time" placeholder="Select the time:">
                        ...
                        <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Descreption" name="des" id="des"
                        ...
                        <?php echo "<form action='make_appointment.php' method='post'>
                                <input type='hidden' name='worker_email' value='".$worker_email."'>
                                <input type='submit' value='Make Appointment' class='btn mt-5 btn-primary py-3 px-5'>
                            </form>";?>  
                        </form>
                        <div class="col-12">
