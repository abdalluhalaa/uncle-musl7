...
//  admin panel end  
    ...
    $sql = "SELECT worker_email, date, time,title, des FROM appointments WHERE id = '$appointment_id'";
...
<head>
    <meta charset="utf-8">
    <title>Uncle Musl7 - Edit Appointment</title>
...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
 ...
 <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight"> Edit Appointment</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="index.php">My Orders</a></li>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="display-5 mt-5 mb-4">Determined to fix faults quickly and to the highest standard</h1>
                    
                    <div class="row g-4">
                        <div class="col-6">
                            <div class="d-flex">
                                <div hidden class="flex-shrink-0 btn-square bg-primary rounded-circle">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <input type="hidden" id="worker_email" name="worker_email" value="<?php echo $worker_email; ?>">
                        ...
                        <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="time" class="form-control" name="time" id="time" value="<?php echo $time; ?>">
                        ...
                        <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="des" id="des"
                                        style="height: 150px" value="<?php echo $des; ?>"></textarea>
                        ...
                        <input type="submit" value="Update" class='btn mt-5 btn-primary py-3 px-5'>
